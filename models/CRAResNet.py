...
class CRA(nn.Module):
    def __init__(self, channels, pooling_size=7):
        super(CRA, self).__init__()
        self.pooling_size = pooling_size
        self.conv_cra = nn.Conv2d(channels, channels, kernel_size=pooling_size, groups=channels, bias=True)
